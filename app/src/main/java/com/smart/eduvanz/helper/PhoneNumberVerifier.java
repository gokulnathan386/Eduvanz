...
public class PhoneNumberVerifier extends Service {
    ...
    public static final String ACTION_VERIFICATION_STATUS_CHANGE = "com.example.biometric.action.verification_status_change";
    ...
    private static final String ACTION_VERIFY = "com.example.biometric.action.verify";
    private static final String ACTION_VERIFY_MESSAGE = "com.example.biometric.action.message";
    private static final String ACTION_CANCEL = "com.example.biometric.action.cancel";
    private static final String EXTRA_PHONE_NUMBER = "com.example.biometric.extra.PHONE_NUMBER";
    private static final String EXTRA_MESSAGE = "com.example.biometric.extra.MESSAGE";
